...
int main(int argc, char **argv)
{
    ...
    main_thread_priority = sched_get_priority_max(SCHED_FIFO); //get max priority of FIFO scheduling
    ...
    thread_ptr=Calloc(3,sizeof(workers_t));   //space for 3 threads allocated and a pointer returned. The space is set to 0
	for(i=0;i<3;i++)
...
{
 	int connfd,policy;
	pthread_t w_priority = pthread_self(); //returns ID of the calling thread
